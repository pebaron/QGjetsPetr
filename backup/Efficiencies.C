...
TH1D * h_probes = new TH1D("h_probes", "h_probes", 22, -2.7,2.7);
TH1D * h_matches = new TH1D("h_matches", "h_matches", 22, -2.7,2.7);
   if (fChain == 0) return;
   ...
   h_matches->Divide(h_probes);
   h_matches->Draw("hist e1");
