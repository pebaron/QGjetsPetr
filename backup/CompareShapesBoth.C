...
int CompareShapesBoth(TString Cut = "", TString ObjectToPlot = "2B0SParticleLJet", 
    ...
    bool bool_inv_mass_SM_022 = (inv_mass_SM_022->Integral() > 100.) ? true : false;
    bool bool_inv_mass_Y0_022 = (inv_mass_Y0_022->Integral() > 100.) ? true : false;
    bool bool_inv_mass_SM_032 = (inv_mass_SM_032->Integral() > 100.) ? true : false;
    bool bool_inv_mass_Y0_032 = (inv_mass_Y0_032->Integral() > 100.) ? true : false;
    bool bool_inv_mass_SM_122 = (inv_mass_SM_122->Integral() > 100.) ? true : false;
    bool bool_inv_mass_Y0_122 = (inv_mass_Y0_122->Integral() > 100.) ? true : false;
    bool bool_inv_mass_SM_132 = (inv_mass_SM_132->Integral() > 100.) ? true : false;
    bool bool_inv_mass_Y0_132 = (inv_mass_Y0_132->Integral() > 100.) ? true : false;
    bool bool_inv_mass_SM_232 = (inv_mass_SM_232->Integral() > 100.) ? true : false;
    bool bool_inv_mass_Y0_232 = (inv_mass_Y0_232->Integral() > 100.) ? true : false;
