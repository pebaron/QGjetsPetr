...
// 
        ...
        cans[i]->SaveAs(TString::Format("./angs1D/1D_%s.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs1D/1D_%s.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs1D/1D_mmdt_%s.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs1D/1D_mmdt_%s.pdf", CanName.Data()));
