...
Energies.push_back("900_7000");
    ...
    for (int i=0;i<vec_quark.size();i++){
        ...
        cans[i]->SaveAs(TString::Format("./angs2D_pythia/2D_%s.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs2D_pythia/2D_%s.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_pythia/2D_mmdt_%s.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_pythia/2D_mmdt_%s.pdf", CanName.Data()));
