...
nominalNoMPINoISR["2360_13000"] = new TFile("qg_angs_noMPI_noISR_2360_13000.root","read");
nominalNoMPINoISR["2360_7000"] = new TFile("qg_angs_noMPI_noISR_2360_7000.root","read");
nominalNoMPINoISR["7000_13000"] = new TFile("qg_angs_noMPI_noISR_7000_13000.root","read");
nominalNoMPINoISR["900_13000"] = new TFile("qg_angs_noMPI_noISR_900_13000.root","read");
nominalNoMPINoISR["900_2360"] = new TFile("qg_angs_noMPI_noISR_900_2360.root","read");
nominalNoMPINoISR["900_7000"] = new TFile("qg_angs_noMPI_noISR_900_7000.root","read");
nominal["2360_13000"] = new TFile("qg_angs_2360_13000.root","read");
nominal["2360_7000"]  = new TFile("qg_angs_2360_7000.root","read");
nominal["7000_13000"] = new TFile("qg_angs_7000_13000.root","read");
nominal["900_13000"]  = new TFile("qg_angs_900_13000.root","read");
nominal["900_2360"]   = new TFile("qg_angs_900_2360.root","read");
nominal["900_7000"]   = new TFile("qg_angs_900_7000.root","read");
...
// 
        ...
        cans[i]->SaveAs(TString::Format("./angs2D_filter/2D_%s.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs2D_filter/2D_%s.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter/2D_mmdt_%s.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter/2D_mmdt_%s.pdf", CanName.Data()));
