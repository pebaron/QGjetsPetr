...
int GenerateAngTest2(TString EnergyA = "7000", TString EnergyB = "13000", bool Pythia = false){
   ...
   TFile * output;
   if (Pythia){
       output = new TFile(TString::Format("test2_qg_angs_%s_%s_pythia.root", EnergyA.Data(), EnergyB.Data() ), "recreate" );
   }else{
       output = new TFile(TString::Format("test2_qg_angs_%s_%s.root", EnergyA.Data(), EnergyB.Data() ), "recreate" );
   }
