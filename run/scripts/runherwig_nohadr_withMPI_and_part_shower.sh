...
rm -rf /disk0/QGjetsPetr/run/files_nohadr_withMPI_and_part_shower/${FileName2} 
mkdir /disk0/QGjetsPetr/run/files_nohadr_withMPI_and_part_shower/${FileName2}
cd /disk0/QGjetsPetr/run/files_nohadr_withMPI_and_part_shower/$FileName2
