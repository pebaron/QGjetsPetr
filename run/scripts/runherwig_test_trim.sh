...
rm -rf /disk0/QGjetsPetr/run/files_test_trim/${FileName2} 
mkdir /disk0/QGjetsPetr/run/files_test_trim/${FileName2}
cd /disk0/QGjetsPetr/run/files_test_trim/${FileName2}
