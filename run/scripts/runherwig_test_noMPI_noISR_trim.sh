...
rm -rf /disk0/QGjetsPetr/run/files_test_noMPI_noISR_trim/${FileName2} 
mkdir /disk0/QGjetsPetr/run/files_test_noMPI_noISR_trim/${FileName2}
cd /disk0/QGjetsPetr/run/files_test_noMPI_noISR_trim/${FileName2}
...
echo "insert /Herwig/Analysis/Rivet:Analyses 0 MC_DIJET_PB_CH_TRIM" >> $FileName
