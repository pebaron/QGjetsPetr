...
echo "---------------------DONE------------------------------------"
cd /disk0/QGjetsPetr/run/files_test/$FileName2
mv test.root ../13000_hadr.root
cd /disk0/QGjetsPetr/run/scripts/
source ./runprod.sh 900 13000
cd /disk0/QGjetsPetr/run/scripts/
root -l "./CheckChi2.C(\"${val}\")" &> chi2_{$val}.txt
cd /disk0/QGjetsPetr/run/files_test/
mv 13000_hadr.root 13000_hadr_{$val}.root
