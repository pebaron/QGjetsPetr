...
FileName="Hadr_Pt_Test_Energy_${Energy}_NEvt_${Events}_Seed_${Seed}_PtWindow_${Window}_PDF_${PDF}_${Hadronization}.in"
FileName2="Hadr_Pt_Test_Energy_${Energy}_NEvt_${Events}_Seed_${Seed}_PtWindow_${Window}_PDF_${PDF}_${Hadronization}"

rm -rf /disk0/QGjetsPetr/run/files_test/${FileName2} 
mkdir /disk0/QGjetsPetr/run/files_test/${FileName2}
cd /disk0/QGjetsPetr/run/files_test/$FileName2
