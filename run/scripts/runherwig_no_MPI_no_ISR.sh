...
rm -rf /disk0/QGjetsPetr/run/files_no_MPI_no_ISR/${FileName2} 
mkdir /disk0/QGjetsPetr/run/files_no_MPI_no_ISR/${FileName2}
cd /disk0/QGjetsPetr/run/files_no_MPI_no_ISR/$FileName2
