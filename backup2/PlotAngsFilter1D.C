...
Energies.push_back("900_7000");
    ...
    TFile * output = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/angs_herwig1D.root", "recreate");
    output->cd();
...
// 
        ...
        cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig/1D_%s_herwig.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig/1D_%s_herwig.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs1D_filter_herwig/1D_mmdt_%s_herwig.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs1D_filter_herwig/1D_mmdt_%s_herwig.pdf", CanName.Data()));
