...
int PlotAngsFilterHervsPytTrim(){
...
nominal["2360_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_2360_13000.root","read");
nominal["2360_7000"]  = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_2360_7000.root","read");
nominal["7000_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_7000_13000.root","read");
nominal["900_13000"]  = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_13000.root","read");
nominal["900_2360"]   = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_2360.root","read");
nominal["900_7000"]   = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_7000.root","read");
...
// 
        ...
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            leg->AddEntry(vec_quark[i][j], TString::Format("%s ang. (Herwig) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Quark";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_No_MPI_quark[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Gluon";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_gluon[i][j], TString::Format("%s ang. (Herwig) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Gluon";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_No_MPI_gluon[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        ...
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            leg2->AddEntry(vec_quark[i][j], TString::Format("%s ang. (Herwig) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_No_MPI_quark[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg22 = "Quark";//
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_No_MPI_quark[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_gluon[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_gluon[i][j], TString::Format("%s ang. (Herwig) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_No_MPI_gluon[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg22 = "Gluon";//
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_No_MPI_gluon[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        ...
        cans[i]->SaveAs(TString::Format("./angs2D_filter_herwig_vs_pythia_trim/2D_%s_herwig_vs_pythia.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs2D_filter_herwig_vs_pythia_trim/2D_%s_herwig_vs_pythia.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter_herwig_vs_pythia_trim/2D_mmdt_%s_herwig_vs_pythia.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter_herwig_vs_pythia_trim/2D_mmdt_%s_herwig_vs_pythia.pdf", CanName.Data()));
