...
int PlotAngsFilterPytvsTrim(){

std::map<TString, TFile*> nominal;
std::map<TString, TFile*> nominalNoMPINoISR;

nominalNoMPINoISR["2360_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_2360_13000_pythia.root","read");
nominalNoMPINoISR["2360_7000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_2360_7000_pythia.root","read");
nominalNoMPINoISR["7000_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_7000_13000_pythia.root","read");
nominalNoMPINoISR["900_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_13000_pythia.root","read");
nominalNoMPINoISR["900_2360"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_2360_pythia.root","read");
nominalNoMPINoISR["900_7000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_trim_900_7000_pythia.root","read");
nominal["2360_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_2360_13000_pythia.root","read");
nominal["2360_7000"]  = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_2360_7000_pythia.root","read");
nominal["7000_13000"] = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_7000_13000_pythia.root","read");
nominal["900_13000"]  = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_900_13000_pythia.root","read");
nominal["900_2360"]   = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_900_2360_pythia.root","read");
nominal["900_7000"]   = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/qg_angs_900_7000_pythia.root","read");
...
Energies.push_back("900_7000");
    ...
    for (int i = 0; i < Radii.size();i++){
        for (int j = 0; j < Lambdas.size();j++){
            for (int k = 0; k < Q.size();k++){
                quark_JetAng.push_back( TString::Format("Final_quark_FastJets%s%sLam%s", Radii[i].Data(), Lambdas[j].Data(), Q[k].Data() ) );
                gluon_JetAng.push_back( TString::Format("Final_gluon_FastJets%s%sLam%s", Radii[i].Data(), Lambdas[j].Data(), Q[k].Data() ) );
                mmdt_quark_JetAng.push_back( TString::Format("Final_quark_mmdt_mmdt_FastJets%s%sLam%s", Radii[i].Data(), Lambdas[j].Data(), Q[k].Data() ) );
                mmdt_gluon_JetAng.push_back( TString::Format("Final_gluon_mmdt_mmdt_FastJets%s%sLam%s", Radii[i].Data(), Lambdas[j].Data(), Q[k].Data() ) );
            }
        }
    }
    ...
    //for (int i = 0; i < 1;i++){
        for (int j = 0; j < Energies.size();j++){
            cout << Energies[j].Data() << " " << gluon_JetAng[i] << " i = " << i << ", j = " << j << endl;
            st_hq=(THStack*)nominal[Energies[j].Data()]->Get(quark_JetAng[i]);
            st_hq->SetName(TString::Format("%s_%s", Energies[j].Data(), st_hq->GetName()));
            st_hq->SetTitle(TString::Format("%s_%s", Energies[j].Data(), st_hq->GetTitle()));


            st_hg=(THStack*)nominal[Energies[j].Data()]->Get(gluon_JetAng[i]);
            st_hg->SetName(TString::Format("%s_%s", Energies[j].Data(),  st_hg->GetName()));
            st_hg->SetTitle(TString::Format("%s_%s", Energies[j].Data(), st_hg->GetTitle()));

            st_mmdt_hq=(THStack*)nominal[Energies[j].Data()]->Get(mmdt_quark_JetAng[i]);
            st_mmdt_hq->SetName(TString::Format("%s_%s", Energies[j].Data(),  st_mmdt_hq->GetName()));
            st_mmdt_hq->SetTitle(TString::Format("%s_%s", Energies[j].Data(), st_mmdt_hq->GetTitle()));

            st_mmdt_hg=(THStack*)nominal[Energies[j].Data()]->Get(mmdt_gluon_JetAng[i]);
            st_mmdt_hg->SetName(TString::Format("%s_%s", Energies[j].Data(),  st_mmdt_hg->GetName()));
            st_mmdt_hg->SetTitle(TString::Format("%s_%s", Energies[j].Data(), st_mmdt_hg->GetTitle()));

            //
            st_No_MPI_hq=(THStack*)nominalNoMPINoISR[Energies[j].Data()]->Get(quark_JetAng[i]);
            st_No_MPI_hq->SetName(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(),  st_No_MPI_hq->GetName()));
            st_No_MPI_hq->SetTitle(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(), st_No_MPI_hq->GetTitle()));

            st_No_MPI_hg=(THStack*)nominalNoMPINoISR[Energies[j].Data()]->Get(gluon_JetAng[i]);
            st_No_MPI_hg->SetName(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(),  st_No_MPI_hg->GetName()));
            st_No_MPI_hg->SetTitle(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(), st_No_MPI_hg->GetTitle()));

            st_No_MPI_mmdt_hq=(THStack*)nominalNoMPINoISR[Energies[j].Data()]->Get(mmdt_quark_JetAng[i]);
            st_No_MPI_mmdt_hq->SetName(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(),  st_No_MPI_mmdt_hq->GetName()));
            st_No_MPI_mmdt_hq->SetTitle(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(), st_No_MPI_mmdt_hq->GetTitle()));

            st_No_MPI_mmdt_hg=(THStack*)nominalNoMPINoISR[Energies[j].Data()]->Get(mmdt_gluon_JetAng[i]);
            st_No_MPI_mmdt_hg->SetName(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(),  st_No_MPI_mmdt_hg->GetName()));
            st_No_MPI_mmdt_hg->SetTitle(TString::Format("%s_%s_NoMPI_NoISR", Energies[j].Data(), st_No_MPI_mmdt_hg->GetTitle()));

            hq = FilterStack(st_hq);
            hg = FilterStack(st_hg);
            mmdt_hq = FilterStack(st_mmdt_hq);
            mmdt_hg = FilterStack(st_mmdt_hg);
            No_MPI_hq = FilterStack(st_No_MPI_hq);
            No_MPI_hg = FilterStack(st_No_MPI_hg);
            No_MPI_mmdt_hq = FilterStack(st_No_MPI_mmdt_hq);
            No_MPI_mmdt_hg = FilterStack(st_No_MPI_mmdt_hg);
    ...
    //TFile * output = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/angs_herwig.root", "recreate");
    //output->cd();
...
// 
        ...
        gPad->Modified();
        gPad->Update();
        leg = new TLegend(0.5,0.43,0.86,0.86);
        leg->SetBorderSize(0);
        leg->SetFillStyle(0);
        ...
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            leg->AddEntry(vec_quark[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Quark";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_No_MPI_quark[i][j], TString::Format("%s ang. (Pythia Trim) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Gluon";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_gluon[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            TString sleg2 = "Gluon";//
            TString sleg3 = ((TObjString *)(tx->At(3)))->String();
            leg->AddEntry(vec_No_MPI_gluon[i][j], TString::Format("%s ang. (Pythia Trim) using %s-%s GeV",sleg2.Data(), sleg0.Data(), sleg1.Data() ));
        }
        ...
        for (int j=0;j<vec_quark[i].size();j++){
            ...
            leg2->AddEntry(vec_quark[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_No_MPI_quark[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg22 = "Quark";//
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_No_MPI_quark[i][j], TString::Format("%s ang. (Pythia Trim) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_gluon[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_gluon[i][j], TString::Format("%s ang. (Pythia) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        for (int j=0;j<vec_quark[i].size();j++){
            LegName = vec_No_MPI_gluon[i][j]->GetName();
            LegName = LegName.ReplaceAll("_", " ");
            ...
            TString sleg22 = "Gluon";//
            TString sleg23 = ((TObjString *)(tx->At(3)))->String();
            leg2->AddEntry(vec_No_MPI_gluon[i][j], TString::Format("%s ang. (Pythia Trim) using %s-%s GeV",sleg22.Data(), sleg20.Data(), sleg21.Data() ));
        }
        ...
        cans[i]->SaveAs(TString::Format("./angs2D_filter_pythia_vs_trim/2D_%s_herwig_vs_pythia.png", CanName.Data()));
        cans[i]->SaveAs(TString::Format("./angs2D_filter_pythia_vs_trim/2D_%s_herwig_vs_pythia.pdf", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter_pythia_vs_trim/2D_mmdt_%s_herwig_vs_pythia.png", CanName.Data()));
        cans2[i]->SaveAs(TString::Format("./angs2D_filter_pythia_vs_trim/2D_mmdt_%s_herwig_vs_pythia.pdf", CanName.Data()));
