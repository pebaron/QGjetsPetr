...
int PlotAngsFilter1DAverage(int Pythia = 0, TString QPar = "50"){
...
Energies.push_back("900_7000");
    ...
    TFile * output = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/angs_herwig1D_average.root", "recreate");
    output->cd();
