...
int PlotAngsFilter1DAverageMMDT(int Pythia = 0, TString QPar = "50"){
...
Energies.push_back("900_7000");
    ...
    TFile * output = new TFile("/media/petr/DATADRIVE1/Users/petrb/Documents/angs_herwig1D_average_mmdt.root", "recreate");
    output->cd();
...
cout << "test1" << endl;
        ...
        //average_No_MPI_quark->Draw("C2 same");
        //average_No_MPI_gluon->Draw("2C same");
        ...
        if (Pythia==1){
            cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig_average/1D_%s_pythia_average.png", CanName.Data()));
            cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig_average/1D_%s_pythia_average.pdf", CanName.Data()));
        }else{
            cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig_average/1D_%s_herwig_average.png", CanName.Data()));
            cans[i]->SaveAs(TString::Format("./angs1D_filter_herwig_average/1D_%s_herwig_average.pdf", CanName.Data()));
        }
